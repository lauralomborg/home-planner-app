...
export interface RoomConnection {
  ...
  axis: 'horizontal' | 'vertical'  // horizontal = rooms stacked vertically (top/bottom), vertical = side by side (left/right)
  roomSides: [RoomSide, RoomSide]  // Which side of each room participates in the connection
}
